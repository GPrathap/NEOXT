...
flags.DEFINE_string("checkpoint_dir", "/data/checkpoint90", "Directory name to save the checkpoints [checkpoint]")
flags.DEFINE_string("sample_dir", "/data/samples90", "Directory name to save the image samples [samples]")
flags.DEFINE_string("feature_dir", "/data/features90", "Directory name to save features")
